...
enum svarid {
	...
	sv_ModeNoUpdate,sv_ModeOver,sv_ModePerl,sv_ModeReadFirst,sv_ModeReadOnly,sv_ModeRegexp,sv_ModeReplace,sv_ModeRuby,
	sv_ModeSafeSave,sv_ModeShell,sv_ModeWorkDir,sv_ModeWrap,sv_OS,sv_RegionText,sv_ReturnMsg,sv_RunFile,sv_RunName,
	sv_TermCols,sv_TermRows,sv_WindCount,sv_WindList,sv_WorkDir,
	...
	sv_palette,
#endif
	sv_randNumSeed,sv_replace,sv_screenNum,sv_search,sv_searchDelim,sv_showModes,sv_softTabSize,sv_travJumpSize,sv_vertJump,
	sv_windLineNum,sv_windNum,sv_windSize,sv_wordChars,sv_wrapCol
	};
...
#define V_NIL		0x0008		// Nil assignment allowed to system variable.
#define V_GLOBAL	0x0010		// Global variable (in user variable table).
#define V_ESCDELIM	0x0020		// Use escape character as input delimiter when prompting for a value.
...
#define TERM_C_VAR	0x01000000	// Variable name -- all.
#define TERM_C_SVAR	0x02000000	// Variable name -- excluding constants.

#define TERM_C_MASK	(TERM_C_CFAM | TERM_C_BUFFER | TERM_C_FNAME | TERM_C_VAR | TERM_C_SVAR)
...
typedef struct Buffer {
	...
	Mark b_mroot;			// Dot mark 0 and list root.
...
#define MDRD1ST		0x0100		// Read first file at startup.
#define MDREGEXP	0x0200		// Regular expresions in search.
#define MDSAFE		0x0400		// Safe file save mode.
#define MDWKDIR		0x0800		// Working directory display mode.
...
typedef struct {
	uint lastread;			// Last key read from getkey().
	uint lastkseq;			// Last key sequence (extended key) returned from getkseq().
	bool uselast;			// Use lastkseq for next key?
	uint chpending;			// Character pushed back via tungetc().
...
enum cfid {
	...
	cf_endLine,cf_endWhite,cf_endWord,cf_entabLine,cf_env,cf_eval,cf_exit,cf_fileExistsQ,cf_findFile,cf_forwChar,
	cf_forwLine,cf_forwPage,cf_forwPageNext,cf_forwPagePrev,cf_forwTab,cf_forwWord,cf_getKey,cf_gotoFence,cf_gotoLine,
	cf_gotoMark,cf_growWind,cf_help,cf_hideBuf,cf_huntBack,cf_huntForw,cf_includeQ,cf_indentRegion,cf_index,cf_insert,
	cf_insertBuf,cf_insertFile,cf_insertLineI,cf_insertPipe,cf_insertSpace,cf_inserti,cf_intQ,cf_join,cf_joinLines,
	cf_joinWind,cf_killFencedText,cf_killLine,cf_killRegion,cf_killToBreak,cf_killWord,cf_lcLine,cf_lcRegion,cf_lcString,
	cf_lcWord,cf_length,cf_let,cf_markBuf,cf_match,cf_metaPrefix,cf_moveWindDown,cf_moveWindUp,cf_narrowBuf,cf_negativeArg,
	cf_newScreen,cf_newline,cf_newlineI,cf_nextArg,cf_nextBuf,cf_nextScreen,cf_nextWind,cf_nilQ,cf_notice,cf_nullQ,
	cf_numericQ,cf_onlyWind,cf_openLine,cf_ord,cf_outdentRegion,cf_overwrite,cf_pathname,cf_pause,cf_pipeBuf,cf_pop,
	cf_prefix1,cf_prefix2,cf_prefix3,cf_prevBuf,cf_prevScreen,cf_prevWind,cf_print,cf_prompt,cf_push,cf_queryReplace,
	cf_quickExit,cf_quote,cf_quoteChar,cf_rand,cf_readBuf,cf_readFile,cf_readPipe,cf_redrawScreen,cf_replace,cf_replaceText,
	cf_resetTerm,cf_resizeWind,cf_restoreBuf,cf_restoreWind,cf_reverse,cf_run,cf_saveBuf,cf_saveFile,cf_saveWind,
	cf_scratchBuf,cf_searchBack,cf_searchForw,cf_selectBuf,cf_setBufFile,cf_setBufName,cf_setHook,cf_setMark,cf_setWrapCol,
	cf_seti,cf_shQuote,cf_shell,cf_shellCmd,cf_shift,cf_showBindings,cf_showBuffers,cf_showFunctions,cf_showHooks,
	cf_showKey,cf_showKillRing,cf_showMarks,
#if MMDEBUG & DEBUG_SHOWRE
	cf_showRegexp,
#endif
	cf_showScreens,cf_showVariables,cf_shrinkWind,cf_space,cf_splitWind,cf_sprintf,cf_stringQ,cf_stringFit,cf_strip,cf_sub,
	cf_subLine,cf_subString,cf_suspend,cf_swapMark,cf_tab,cf_tcString,cf_tcWord,cf_toInt,cf_toString,cf_tr,cf_traverseLine,
	cf_trimLine,cf_truncBuf,cf_ucLine,cf_ucRegion,cf_ucString,cf_ucWord,cf_unbindKey,cf_unchangeBuf,cf_undelete,
	cf_unhideBuf,cf_universalArg,cf_unshift,cf_updateScreen,cf_viewFile,cf_voidQ,cf_whence,cf_widenBuf,cf_wordCharQ,
	cf_wrapLine,cf_wrapWord,cf_writeBuf,cf_writeFile,cf_xPathname,cf_xeqBuf,cf_xeqFile,cf_xeqKeyMacro,cf_yank,cf_yankPop
	};
...
#define MCE_EOSALT	8		// End of string or just before trailing CR.
#define MCE_EOS		9		// End of string.
#define MCE_GRPBEGIN	10		// Beginning of group.
#define MCE_GRPEND	11		// End of group.

// Metacharacter element types for replacements (in the mc_type member of ReplMetaChar below).
#define MCE_LITSTRING	12		// Literal string.
#define MCE_GROUP	13		// String of group match.
#define MCE_MATCH	14		// String of entire match.
...
#define MC_EOSALT	'Z'		// End of string or just before trailing CR (\Z).
...
#define SOPT_MULTI	0x0010		// Multiline mode ('.' and [^...] match '\r').
#define SOPT_PLAIN	0x0020		// Plain-text mode.
#define SOPT_REGEXP	0x0040		// Regexp mode.
#define SOPT_LIT	0x0080		// OPTCH_BEGIN is in literal form, as in "x::e".
#define SOPT_ALL	(SOPT_EXACT | SOPT_IGNORE | SOPT_MULTI | SOPT_PLAIN | SOPT_REGEXP | SOPT_LIT)
