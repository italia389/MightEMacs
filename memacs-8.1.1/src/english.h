...
#define ALIT_maxPat		"Maximum length of search pattern"
 ...
 *text55,*text56,*text57,*text58,*text59,*text60,*text61,
 ...
 *text233,*text234,*text235,*text236,*text237,*text238,*text239,*text240,*text241,
