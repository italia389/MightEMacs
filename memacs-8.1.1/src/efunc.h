...
extern int bufop(Value *rp,int n,char *prmtp,int op,uint flag);
...
extern int complete(Value *rp,char *prmtp,char *defvalp,uint cflags,uint maxlen,uint aflags);
...
extern int getarg(Value *rp,char *prmtp,char *defvalp,int terminator,uint aflags);
extern KeyDesc *getbind(int c);
extern int getbuflist(Value *rp);
extern int getcam(char *prmtp,uint selector,FABPtr *fabp,char *emsg);
...
extern int readpattern(char *prmtp,int srch);
...
extern int termarg(Value *rp,char *prmtp,char *defvalp,int terminator,uint aflags);
