...
#define NPAT		1024		// Number of bytes, pattern.
#define NTERMINP	1024		// Number of bytes, terminal input (must be >= NPAT).
...
#define BOPREADBUF	4		// Read line(s) from a buffer.
...
enum svarid {
	...
	sv_horzScrollCol,sv_inpDelim,sv_keyMacro,sv_lastKeySeq,sv_lineChar,sv_lineCol,sv_lineOffset,sv_lineText,sv_maxLoop,
	sv_maxRecursion,sv_modeHook,sv_otpDelim,sv_pageOverlap,
#if COLOR
	sv_palette,
#endif
...
#define HKWRAP		7		// Word wrap hook.
#define HKWRITE		8		// Write file hook.
...
enum cfid {
	...
	cf_undelete,cf_unhideBuf,cf_universalArg,cf_unshift,cf_updateScreen,cf_viewFile,cf_whence,cf_widenBuf,cf_wrapLine,
	cf_wrapWord,cf_writeBuf,cf_writeFile,cf_xPathname,cf_xPrefix,cf_xeqBuf,cf_xeqFile,cf_xeqKeyMacro,cf_yank,cf_yankPop
	};
