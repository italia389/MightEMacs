...
int terminp(Datum *rp,char *prmt,char *defval,uint terminator,uint maxlen,uint aflags,uint cflags) {
	int terminator2;
...
int getarg(Datum *rp,char *prmt,char *defval,uint terminator,uint maxlen,uint aflags,uint cflags) {
