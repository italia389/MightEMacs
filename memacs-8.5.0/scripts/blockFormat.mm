...
macro bfFormatItem(0)  {desc: 'Format a block of comment lines or one list item'}
...
# first item block.
macro bfFormatList(0) {desc: 'Format an ordered list of one or more contiguous item blocks'}
