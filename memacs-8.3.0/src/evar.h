...
enum sconstid {
	...
	sc_ModeMsgDisp,sc_ModeNoUpdate,sc_ModeOver,sc_ModePerl,sc_ModeReadFirst,sc_ModeReadOnly,sc_ModeRegexp,sc_ModeReplace,
	sc_ModeRuby,sc_ModeSafeSave,sc_ModeShell,sc_ModeWorkDir,sc_ModeWrap,sc_OS
	};
...
static SVar sysvars[] = {
	...
	{"$ModeReadFirst",	sv_ModeReadFirst,V_RDONLY | V_INT | V_MODE,(char *) (gmodeinfo + MDO_RD1ST),sysconsts + sc_ModeReadFirst},
	...
	{"$replace",		sv_replace,		V_NIL | V_ESCDELIM,VLIT_replace,NULL},
	{"$screenNum",		sv_screenNum,		V_INT,		VLIT_screenNum,NULL},
	{"$search",		sv_search,		V_NIL | V_ESCDELIM,VLIT_search,NULL},
