...
CmdFunc cftab[] = {
	...
	{"chDir",		0,			1,	1,	changedir,	LITERAL38,	FLIT_chDir},
	...
	{"deleteBuf",		0,			0,	-1,	deleteBuf,	LITERAL37,	FLIT_deleteBuf},
	...
	{"huntForw",		CFNCOUNT,		0,	0,	huntForw,	"",		FLIT_huntForw},
		// Returns string found, or false if not found.
	{"include?",	CFFUNC | CFNIL3 | CFBOOL3,	3,	3,	NULL,		LITERAL29,	FLIT_includeQ},
	...
	{"showModes",		0,			0,	0,	showModes,	"",		FLIT_showModes},
	...
	{"stat?",		CFFUNC,			2,	2,	NULL,		LITERAL36,	FLIT_statQ},
