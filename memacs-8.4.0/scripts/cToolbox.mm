...
macro cInit,2
	...
	if $2 != (binding('C-c C-g') == 'cGotoIfEndif')
		$wordChars = ''
		bindings = join "\n","cFindFunc\tC-c C-f","cGotoIfEndif\tC-c C-g","cNukePPLines\tC-c #"
		bindings = join "\n",bindings,"cWrapIf0\tM-0","cWrapIf1\tM-1","cWrapIfElse\tM-2"
		bindings = join "\n",bindings,"cWrapIfName0\tC-c 0","cWrapIfName1\tC-c 1","cWrapIfElseName\tC-c 2"
		eval "#{$1} 'C',bindings,$2"
	endif
endmacro
