# memacs.mm	Ver. 8.0.0.8
#	MightEMacs startup file.

-1 => alterGlobalMode 'msg'
...
!macro getHelp,0
	...
	!loop
		...
		!elsif !nil?(index 'mgr',choice)
			...
			# Display appropriate man page.
			!if (shellCmd 'man ',choice == 'r' ? MacroRef : choice == 'g' ? UserGuide : Man) == false
...
sitePath = xPathname('site') and require sitePath

1 => alterGlobalMode 'msg'
notice 'Site startup file loaded'
