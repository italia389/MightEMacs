...
extern int cPrefix(Value *rp,int n);
...
extern int hPrefix(Value *rp,int n);
...
extern int iortext(Value *vp,int n,enum e_textedit t,bool fupdt);
...
extern int kinsert(int direc,int c);
extern void kprep(bool force);
extern int lalloc(int used,Line **lnpp);
extern void lchange(Buffer *bufp,uint flags);
extern int ldelete(long n,bool kflag);
...
extern int metaPrefix(Value *rp,int n);
...
extern int negativeArg(Value *rp,int n);
...
extern int universalArg(Value *rp,int n);
...
extern int xPrefix(Value *rp,int n);
