...
char
	...
	*usage[] = {
		...
		" [-r] [-S] [-s<string>] [-X<exec-path>] [@<script-file>] [file-spec...]",
		NULL},
	*help2[] = {
 ...
 *text247,*text248,*text249,*text250,*text251,*text252,*text253,*text254,
#if COLOR
 *text255,
#endif
 *text256,*text257,*text258,*text259,*text260,
 ...
 *text354,*text355,*text356,*text357,*text358,*text359,*text360,*text361,*text362;
