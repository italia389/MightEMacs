...
typedef struct KeyBind {
	...
	UnivPtr k_targ;			// Command or macro to execute.
	} KeyBind;
...
#define CFVMove		0x0001		// Last command was a vertical (line) move.
#define CFTrav		0x0002		// Last command was a traverse.
#define CFKill		0x0004		// Last command was a kill.
#define CFDel		0x0008		// Last command was a delete.
#define CFYank		0x0010		// Last command was a yank.
#define CFUndel		0x0020		// Last command was an undelete.
#define CFNMove		0x0040		// Last yank or undelete command did not move point.

// External function declarations.
extern int binding(Datum *rval,int n,Datum **argv);
extern int bindKeyCM(Datum *rval,int n,Datum **argv);
extern char *ektos(ushort ek,char *dest,bool escTermAttr);
extern KeyBind *getbind(ushort ek);
extern int getkb(char *prmt,int n,Datum **argv,ushort *result);
extern int getkey(bool ml,ushort *key,bool savekey);
extern int getKeyF(Datum *rval,int n,Datum **argv);
extern char *getkname(KeyBind *kbind);
extern int getkseq(bool ml,ushort *key,KeyBind **kbindp,bool savekey);
extern KeyBind *getpentry(UnivPtr *univp);
extern int loadbind(void);
extern KeyBind *nextbind(KeyWalk *kwp);
extern int showKey(Datum *rval,int n,Datum **argv);
extern int stoek(char *keylit,ushort *result);
extern void unbindent(KeyBind *kbind);
extern int unbindKey(Datum *rval,int n,Datum **argv);
...
// Function key bindings.
	...
	{Shft | FKey | 'D',cf_delWhite},	// Shift delete [x> key.
