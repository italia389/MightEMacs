...
CmdFunc cftab[] = {
	...
	{"appendFile",		CFNoLoad,0,			1,1,	NULL,		Literal69,	CFLit_appendFile},
		// Returns filename.
	{"apropos",		0,ArgNil1,			1,1,	apropos,	Literal6,	CFLit_apropos},
	...
	{"beginBuf",		CFNoLoad,0,			0,1,	NULL,		Literal9,	CFLit_beginBuf},
	...
	{"bempty?",		CFFunc | CFAddlArg,ArgNotNull1,	0,1,	NULL,		Literal9,	CFLit_bemptyQ},
		// Returns true if specified buffer is empty; otherwise, false.
	{"bgets",		CFFunc | CFNCount | CFNoLoad,0,	1,1,	bgets,		Literal68,	CFLit_bgets},
		// Returns nth next line from buffer.
	{"bindKey",	CFSpecArgs | CFShrtLoad,ArgNotNull1,	2,2,	bindKeyCM,	Literal7,	CFLit_bindKey},
	{"binding",	CFFunc,ArgNotNull1 | ArgNotNull2,	2,2,	binding,	Literal57,	CFLit_binding},
	...
	{"bprintf",		CFFunc,ArgNotNull1,		2,-1,	NULL,		Literal53,	CFLit_bprintf},
		// Returns text written.
	{"bufAttr?",	CFFunc,ArgNotNull1 | ArgNotNull2,	2,2,	bufAttrQ,	Literal64,	CFLit_bufAttrQ},
...
#endif
	{"cycleDelRing",	0,0,				0,0,	NULL,		NULL,		CFLit_cycleDelRing},
	...
	{"defined?",CFFunc,ArgNotNull1 | ArgNotNull2 | ArgInt2 | ArgMay,2,2,isdef,	Literal67,	CFLit_definedQ},
		// Returns kind of object, or nil if not found.
	{"delAlias",		CFSpecArgs | CFNoLoad,0,	1,-1,	delAlias,	Literal8,	CFLit_delAlias},
	...
	{"delBuf",		CFNoLoad,0,			1,-1,	delBuf,		Literal37,	CFLit_delBuf},
		// Returns zero if failure; otherwise, number of buffers deleted.
	{"delDelEntry",		0,0,				0,0,	NULL,		NULL,		CFLit_delDelEntry},
	...
	{"delKillEntry",	0,0,				0,0,	NULL,		NULL,		CFLit_delKillEntry},
	{"delLine",		CFEdit,0,			0,0,	NULL,		NULL,		CFLit_delLine},
	{"delMacro",		CFSpecArgs | CFNoLoad,0,	1,-1,	delMacro,	Literal8,	CFLit_delMacro},
		// Returns zero if failure; otherwise, number of macros deleted.
	{"delMark",		CFNoLoad | CFNoArgs,0,		0,1,	delMark,	Literal52,	CFLit_delMark},
	{"delRegion",		CFEdit,0,			0,0,	NULL,		NULL,		CFLit_delRegion},
	{"delReplacePat",	0,0,				0,0,	NULL,		NULL,		CFLit_delReplacePat},
	{"delScreen",		CFNoLoad,0,			1,1,	delScreen,	Literal21,	CFLit_delScreen},
	{"delSearchPat",	0,0,				0,0,	NULL,		NULL,		CFLit_delSearchPat},
	{"delToBreak",		CFEdit,0,			0,0,	NULL,		NULL,		CFLit_delToBreak},
	{"delWhite",		CFEdit,0,			0,0,	NULL,		NULL,		CFLit_delWhite},
	{"delWind",		CFAddlArg,ArgNotNull1,		0,1,	delWind,	Literal45,	CFLit_delWind},
	...
	{"endBuf",		CFNoLoad,0,			0,1,	NULL,		Literal9,	CFLit_endBuf},
	...
	{"expandPath",		CFFunc,0,			1,1,	NULL,		Literal15,	CFLit_expandPath},
		// Returns pathname with "~/", "~user/", "$var", and "${var}" expanded.
	{"findFile",		CFNoLoad,0,			1,1,	NULL,		Literal69,	CFLit_findFile},
	...
	{"getInfo",		CFFunc,ArgNotNull1,		1,1,	getInfo,	Literal44,	CFLit_getInfo},
		// Returns informational item per keyword argument.
	{"getKey",		CFFunc | CFAddlArg,ArgNotNull1,	0,1,	getKeyF,	Literal45,	CFLit_getKey},
		// Returns key in encoded form.
	{"getWord",		CFFunc,0,			0,0,	getWord,	NULL,		CFLit_getWord},
		// Returns word from current buffer.
	{"glob",		CFFunc,0,			1,1,	globpat,	Literal6,	CFLit_glob},
	...
	{"groupMode?",	CFFunc | CFAddlArg,ArgNotNull1 | ArgNil1 | ArgNotNull2 | ArgNotNull3,
								2,3,	groupMode,	Literal56,	CFLit_groupModeQ},
	...
	{"huntForw",		CFNCount,0,			0,0,	huntForw,	NULL,		CFLit_huntForw},
		// Returns string found, or false if not found.
	{"include?",CFFunc | CFShrtLoad,ArgNil1 | ArgArray2,	3,-1,	doincl,		Literal47,	CFLit_includeQ},
	...
	{"index",	CFFunc | CFAddlArg,ArgInt2 | ArgMay | ArgNotNull3,
								2,3,	indexF,		Literal19,	CFLit_index},
	...
	{"insertBuf",		CFEdit | CFNoLoad,0,		1,1,	insertBuf,	Literal68,	CFLit_insertBuf},
		// Returns name of buffer.
	{"insertFile",		CFEdit | CFNoLoad,0,		1,1,	insertFile,	Literal69,	CFLit_insertFile},
		// Returns filename.
	...
	{"joinWind",		CFAddlArg,ArgNotNull1,		0,1,	joinWind,	Literal45,	CFLit_joinWind},
	...
	{"message",		CFFunc | CFShrtLoad,ArgNil1,	2,-1,	message,	Literal62,	CFLit_message},
	...
	{"mode?",CFFunc | CFAddlArg,ArgNotNull1 | ArgNil1 | ArgNotNull2 | ArgArray2 | ArgMay | ArgNotNull3,
								2,3,	modeQ,		Literal3,	CFLit_modeQ},
	...
	{"overwrite",		CFFunc | CFEdit | CFShrtLoad,0,	1,-1,	NULL,		Literal10,	CFLit_overwrite},
		// Returns new text.
	{"pathname",	CFFunc,ArgArray1 | ArgMay | ArgPath,	1,1,	aPathname,	Literal59,	CFLit_pathname},
	...
	{"popBuf",		CFNoLoad,0,			1,2,	NULL,		Literal43,	CFLit_popBuf},
		// Returns name of buffer.
	{"popFile",		CFNoLoad,0,			1,2,	NULL,		Literal71,	CFLit_popFile},
		// Returns name of buffer.
	...
	{"prompt",		CFFunc,ArgNil1,			1,-1,	uprompt,	Literal24,	CFLit_prompt},
	...
	{"readFile",		CFNoLoad,0,			1,1,	NULL,		Literal69,	CFLit_readFile},
		// Returns name of buffer.
	...
	{"renameBuf",		CFNoLoad,0,			2,2,	renameBuf,	Literal50,	CFLit_renameBuf},
		// Returns name of buffer.
	...
	{"replaceText",		CFFunc | CFEdit | CFShrtLoad,0,	1,-1,	NULL,		Literal10,	CFLit_replaceText},
		// Returns new text.
	{"resetTerm",		0,0,				0,0,	resetTermCmd,	NULL,		CFLit_resetTerm},
	...
	{"scratchBuf",		0,0,				0,0,	scratchBuf,	NULL,		CFLit_scratchBuf},
		// Returns name of buffer.
	{"searchBack",		0,ArgNotNull1,			1,1,	searchBack,	Literal6,	CFLit_searchBack},
		// Returns string found, or false if not found.
	{"searchForw",		0,ArgNotNull1,			1,1,	searchForw,	Literal6,	CFLit_searchForw},
		// Returns string found, or false if not found.
	{"selectBuf",		CFNoLoad,0,			1,1,	selectBuf,	Literal68,	CFLit_selectBuf},
		// Returns name of buffer.
	{"selectLine",		CFFunc,ArgInt1,			1,1,	selectLine,	Literal21,	CFLit_selectLine},
		// Returns number of lines selected.
	{"selectScreen",	CFNoLoad,0,			1,1,	selectScreen,	Literal21,	CFLit_selectScreen},
	{"selectWind",		CFNoLoad,0,			1,1,	selectWind,	Literal21,	CFLit_selectWind},
	{"setBufFile",		CFNoLoad,0,			2,2,	setBufFile,	Literal51,	CFLit_setBufFile},
	...
	{"setDispColor",CFFunc,ArgNotNull1 | ArgArray2 | ArgNil2 | ArgMay,
								2,2,	setDispColor,	Literal66,	CFLit_setDispColor},
	...
	{"seti",		0,ArgInt1 | ArgInt3,		1,3,	seti,		Literal14,	CFLit_seti},
	{"shQuote",		CFFunc,ArgNIS1,			1,1,	NULL,		Literal13,	CFLit_shQuote},
		// Returns quoted string.
	{"shell",		0,0,				0,0,	shellCLI,	NULL,		CFLit_shell},
		// Returns false if failure.
	{"shellCmd",		CFNoLoad,0,			2,-1,	NULL,		Literal62,	CFLit_shellCmd},
		// Returns false if failure.
	{"shift",		CFFunc,ArgArray1,		1,1,	NULL,		Literal23,	CFLit_shift},
		// Returns shifted value, or nil if none left.
	{"showAliases",		0,ArgNil1,			1,1,	showAliases,	Literal6,	CFLit_showAliases},
	{"showBuffers",		0,0,				0,0,	showBuffers,	NULL,		CFLit_showBuffers},
	{"showColors",		0,0,				0,0,	showColors,	NULL,		CFLit_showColors},
	{"showCommands",	0,ArgNil1,			1,1,	showCommands,	Literal6,	CFLit_showCommands},
	{"showDelRing",		0,0,				0,0,	NULL,		NULL,		CFLit_showDelRing},
	{"showDir",		0,0,				0,0,	NULL,		NULL,		CFLit_showDir},
		// Returns absolute pathname of current directory.
	{"showFence",		CFAddlArg,ArgInt1,		0,1,	showFence,	Literal58,	CFLit_showFence},
	{"showFunctions",	0,ArgNil1,			1,1,	showFunctions,	Literal6,	CFLit_showFunctions},
	{"showHooks",		0,0,				0,0,	showHooks,	NULL,		CFLit_showHooks},
	{"showKey",		0,ArgNotNull1,			1,1,	showKey,	Literal16,	CFLit_showKey},
	{"showKillRing",	0,0,				0,0,	NULL,		NULL,		CFLit_showKillRing},
	{"showMacros",		0,ArgNil1,			1,1,	showMacros,	Literal6,	CFLit_showMacros},
...
#endif
	{"showReplaceRing",	0,0,				0,0,	NULL,		NULL,		CFLit_showReplaceRing},
	{"showScreens",		0,0,				0,0,	showScreens,	NULL,		CFLit_showScreens},
	{"showSearchRing",	0,0,				0,0,	NULL,		NULL,		CFLit_showSearchRing},
	{"showVariables",	0,ArgNil1,			1,1,	showVariables,	Literal6,	CFLit_showVariables},
	...
	{"split",		CFFunc,ArgInt1 | ArgNil1 | ArgInt3,
								2,3,	ssplit,		Literal39,	CFLit_split},
		// Returns array.
	...
	{"stat?",		CFFunc,ArgPath,			2,2,	NULL,		Literal36,	CFLit_statQ},
	...
	{"swapMark",		CFNoLoad,0,			0,1,	swapMark,	Literal35,	CFLit_swapMark},
	...
	{"toStr",CFFunc | CFAddlArg,ArgBool1 | ArgArray1 | ArgNIS1 | ArgNotNull2,
								1,2,	toString,	Literal42,	CFLit_toStr},
		// Returns string result.
	...
	{"unshift",CFFunc,ArgArray1 | ArgBool2 | ArgArray2 | ArgNIS2,
								2,2,	NULL,		Literal25,	CFLit_unshift},
		// Returns new array value.
	{"updateScreen",	CFFunc | CFAddlArg,ArgNotNull1,	0,1,	updscr,		Literal45,	CFLit_updateScreen},
	...
	{"viewFile",		CFNoLoad,0,			1,1,	NULL,		Literal69,	CFLit_viewFile},
		// Returns [name of buffer, "true" or "false" indicating whether the buffer was created].
	...
	{"writeBuf",		CFNoLoad,0,			1,1,	writeBuf,	Literal68,	CFLit_writeBuf},
		// Returns text copied.
	{"writeFile",		CFNoLoad,0,			1,1,	NULL,		Literal69,	CFLit_writeFile},
		// Returns filename.
	{"xPathname",CFFunc | CFAddlArg,ArgPath | ArgNotNull2,	1,2,	xPathname,	Literal60,	CFLit_xPathname},
		// Returns pathname, or array of pathnames.
	{"xeqBuf",		CFNoLoad,0,			1,-1,	xeqBuf,		Literal17,	CFLit_xeqBuf},
		// Returns execution result.
	{"xeqFile",		CFNoLoad,0,			1,-1,	xeqFile,	Literal70,	CFLit_xeqFile},
		// Returns execution result.
