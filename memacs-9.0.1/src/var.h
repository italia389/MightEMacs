...
enum svarid {
	// Immutables.
	sv_ARGV,sv_BufInpDelim,sv_BufModes,sv_Date,sv_GlobalModes,sv_HorzScrollCol,sv_LineLen,sv_Match,sv_RegionText,
	sv_ReturnMsg,sv_RunFile,sv_RunName,sv_ScreenCount,sv_ShowModes,sv_TermCols,sv_TermRows,sv_WindCount,
...
static SVar sysvars[] = {
	...
	{"$ShowModes",		sv_ShowModes,		V_RdOnly | V_Array,VLit_ShowModes,NULL},
