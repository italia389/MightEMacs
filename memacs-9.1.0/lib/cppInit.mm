...
[nil,								/# Library name (if different from mode name) #/\
 ...
 'cpp',								/# Macro and library name prefix #/\
 ['cpp','cc','C','CPP','cxx','c++','hpp','hh','H','HPP','hxx','h++'],	/# Array of extensions used for source files #/\
 ...
 ['do','else','if','for','switch','while'],			/# BOL indenting next (strings and/or keywords) #/\
