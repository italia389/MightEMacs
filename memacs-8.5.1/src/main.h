...
extern int getarg(Datum *rp,char *prmt,char *defval,ushort terminator,uint maxlen,uint aflags,uint cflags);
...
extern int terminp(Datum *rp,char *prmt,char *defval,ushort terminator,uint maxlen,uint aflags,uint cflags);
