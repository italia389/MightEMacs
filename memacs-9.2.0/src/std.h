...
#define VertJump	20		// Default vertical jump size (percentage).
#define VertJumpStr	"20"		// VertJump in string form.
...
#define ColorBrown	88		// Best color number for dark brown.
#define ColorGreen	2		// Best color number for medium green.
#define ColorRed	9		// Best color number for bright red.
#define ColorWhite	15		// Best color number for bright white.
...
typedef short ColorPair[2];		// Foreground and background color numbers.
typedef struct {
	...
	short colorWhite;		// Best white color number.
	short colorRed;			// Best red color number.
	short colorGreen;		// Best green color number.
...
enum cfid {
	...
	cf_selectScreen,cf_selectWind,cf_setBufFile,cf_setColorPair,cf_setHook,cf_setMark,cf_setWrapCol,cf_seti,cf_shQuote,
	cf_shell,cf_shellCmd,cf_shift,cf_showAliases,cf_showBuffers,cf_showColors,cf_showCommands,cf_showDir,cf_showFunctions,
	cf_showHooks,cf_showKey,cf_showKillRing,cf_showMacros,cf_showMarks,cf_showModes,cf_showPoint,
...
ETerm term = {
	...
	-1,				// Best white color number.
	-1,				// Best red color number.
	-1,				// Best green color number.
