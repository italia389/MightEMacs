...
enum svarid {
	...
	// Mutables.
	sv_autoSave,sv_bufFile,sv_bufLineNum,sv_bufName,sv_displayColors,sv_execPath,sv_fencePause,sv_hardTabSize,sv_horzJump,
...
static SVar sysvars[] = {
	...
	{"$TermCols",		sv_TermCols,		V_RdOnly | V_Int,	VLit_TermCols},
	{"$TermRows",		sv_TermRows,		V_RdOnly | V_Int,	VLit_TermRows},
	...
	{"$displayColors",	sv_displayColors,	V_Array,		VLit_displayColors},
