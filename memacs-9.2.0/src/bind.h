...
typedef struct {
	...
	KeyBind *kbp;			// Pointer to next binding.
	} KeyWalk;
...
extern int binding(Datum *rp,int n,Datum **argpp);
...
extern int getkey(bool ml,ushort *keyp,bool savekey);
extern char *getkname(KeyBind *kbp);
extern int getkseq(bool ml,ushort *keyp,KeyBind **kbpp,bool savekey);
...
extern void unbindent(KeyBind *kbp);
