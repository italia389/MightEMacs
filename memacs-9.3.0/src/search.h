...
typedef struct {
	...
	Buffer *sc_listp;		// Buffer to put list into.
	DStrFab sc_rpt;
	void *sc_itemp;			// Pointer to current item in list.
...
extern int nextCommand(ShowCtrl *scp,ushort req,char **namep);
extern int nextGlobalVar(ShowCtrl *scp,ushort req,char **namep);
extern int nextLocalVar(ShowCtrl *scp,ushort req,char **namep);
extern int nextMacro(ShowCtrl *scp,ushort req,char **namep);
extern int nextSysVar(ShowCtrl *scp,ushort req,char **namep);
extern bool plainsearch(void);
extern bool rebmode(void);
extern int recmp(Datum *sp,int scanoff,Match *mtp,int *resultp);
extern int replstr(Datum *rp,int n,bool qrepl,Datum **argpp);
...
extern int showbuild(ShowCtrl *scp,ushort flags,char *title,int (*fp)(ShowCtrl *scp,ushort req,char **namep));
extern int showclose(Datum *rp,int n,ShowCtrl *scp);
extern int showopen(ShowCtrl *scp,int n,char *plabel,Datum **argpp);
#if MMDebug & Debug_ShowRE
extern int showRegexp(Datum *rp,int n,Datum **argpp);
#endif
extern int showReplaceRing(Datum *rp,int n,Datum **argpp);
extern int showSearchRing(Datum *rp,int n,Datum **argpp);
extern int sindex(Datum *rp,int n,Datum *srcp,Datum *patp,Match *mtp);
